    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <!-- 
            显示数组中的第几个项的元素需要传入相应的参数，并且参数是响应式的
           -->
          <Zoom
            :imgUrl="
              skuInfo.skuImageList[carouselImgIndex] &&
              skuInfo.skuImageList[carouselImgIndex].imgUrl
            "
          />
          <!-- 小图列表 -->
          <ImageList
            :carouselList="skuInfo.skuImageList"
            :setCarouselImgIndex="setCarouselImgIndex"
          />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
...
/* 
    1.请求数据进行动态渲染
      ...
      请求
        api
        拿到数据进行渲染
        会先渲染页面，再去请求数据，所以第一次渲染的时候是没有数据的
          在vuex中初始化就好了
